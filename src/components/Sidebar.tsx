...
export function Sidebar({
  ...
  return (
    <div className="w-80 bg-slate-900 border-r border-slate-800 p-6 flex flex-col h-full overflow-hidden">
      <div className="mb-8 shrink-0">
        <h1 className="text-2xl font-bold text-white mb-2">
          Escala Enfermagem
        </h1>
        <p className="text-slate-400 text-sm mb-4">Gerenciamento de plantões</p>
                ...
                {NURSE_COLORS.map((color) => {
                  ...
                  return (
                    <button
                      ...
                      title={isUsed ? "Cor em uso" : "Selecionar cor"}
                    >
                      {isSelected && (
                ...
                .map((nurse) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-xs">Padrão</p>
                    </div>
                  </div>
                ))}
            </div>
